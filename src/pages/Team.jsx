...
const Team = () => {
    ...
    const members = [
        ...
        { name: "Pratiksha Pankar", role: "Database Head", color: "#2dd4bf", image: "https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?fit=crop&w=200&h=200" },
        { name: "Gayatri Pawar", role: "Treasurer", color: "#2dd4bf", image:gayu },
        { name: "Neel Malpure", role: "Treasurer", color: "#2dd4bf", image: "https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?fit=crop&w=200&h=200" },
